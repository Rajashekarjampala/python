...
# ------------------------------------------------------------------#
#Testcase 4
result=sum_list([1,10,8,7,4],[32,12,32,21,5],[32,23,29,55,80],100,200)
print("\n")
...
# ------------------------------------------------------------------#
#Testcase 5
result=sum_list([1000,800,300,500,200],[500,787,100,48,900],[43,78,90,55,88],100,500)
print("\n")
...
# ------------------------------------------------------------------#
#TestCase 6
result=sum_list([32,23,29,55,80],[54,43,78,90,55],[95,78,25,71,85],400,200)
print("\n")
...
# ------------------------------------------------------------------#
# TestCase 7
result=sum_list([90,100,98,93,95],[76,42,67,66,34],[100,300,800,50,39],55,45)
print("\n")
...
# ------------------------------------------------------------------#
# TestCase 9
result=sum_list([25,45,65,75,95],[14,35,75,88,95],[78,25,71,85,10],300,100)
print("\n")
...
# ------------------------------------------------------------------#
# TestCase 10
result=sum_list([121,22,456,2337,980],[432,666,77,90,10],[34,75,78,72,48],140,160)
print("\n")
